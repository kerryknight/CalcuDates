//
//  KKVerticalCellSwipeInteractionController.m
//  CalcuDates
//
...
#import "KKVerticalCellSwipeInteractionController.h"

@implementation KKVerticalSwipeInteractionController {
    BOOL _shouldCompleteTransition;
    UIViewController *_viewController;
    UIPanGestureRecognizer *_gesture;
    KKInteractionOperation _operation;
}
...
//    
//    if (operation == KKInteractionOperationTab) {
        ...
        case UIGestureRecognizerStateCancelled:
            if (self.interactionInProgress) {
                ...
                if (!_shouldCompleteTransition || gestureRecognizer.state == UIGestureRecognizerStateCancelled) {
                    ...
                    //knightka
                    //broadcast notification event so other view's can capture and make necessary updates
                    if(_shouldCompleteTransition)[[NSNotificationCenter defaultCenter] postNotificationName:@"interactiveVerticalSwipeTransitionDidComplete" object:nil];
                }
            }
            break;
        default:
